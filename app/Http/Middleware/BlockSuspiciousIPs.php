...
class BlockSuspiciousIPs
{
    ...
    {
        // questo middleware è stato creato per bloccare un utente malintenzionato che vuole scrivere commenti con uno scrypt. se però l'haker vuole cambiare lo script e fare in modo di scrivere il massimo di commenti possibili prima del blocco di 1 minuto semmai cambiamo il blockMinutes e invece di 1 mettiamo 10 o 20
        // oppure mettere un captcha
